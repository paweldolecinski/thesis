...
\begin{tabular}{$>{\em}m{\dimexpr 0.19\linewidth-2\tabcolsep}
						^m{\dimexpr0.27\linewidth-2\tabcolsep}
						^m{\dimexpr 0.27\linewidth-2\tabcolsep}
						^m{\dimexpr0.27\linewidth-2\tabcolsep}}
\toprule
\rowstyle{\bfseries}
...
W literaturze \cite{Harrison1999} wymienia się trzy strategie (typy) grupowego
...
\begin{tabular}{ $m{\dimexpr 0.16\linewidth-2\tabcolsep} 
                 ^m{\dimexpr 0.28\linewidth-2\tabcolsep} 
                 ^m{\dimexpr 0.28\linewidth-2\tabcolsep} 
                 ^m{\dimexpr 0.28\linewidth-2\tabcolsep} }
\toprule
\rowstyle{\bfseries}
 & Rutynowe\newline podejmowanie decyzji & Twórcze\newline podejmowanie
decyzji & Negocjacyjne\newline podejmowanie decyzji \\
\midrule
\textbf{Struktura\newline grupy} & Specjaliści wraz z koordynatorem (przywódcą)
...
\midrule
\textbf{Role\newline grupowe} & Niezależny wysiłek; specjalistyczna wiedza &
Wszystkie pomysły są przedmiotem grupowej dyskusji & Jednostka postrzega się jako
reprezentant zainteresowanej strony \\
\midrule
\textbf{Proces\newline grupowy} & Określenie celów; interakcje pomiędzy
koordynatorem i specjalistami & Proces rozwiązywania problemu z pełną partycypacją i
spontaniczną komunikacją & Uporządkowana komunikacja; sformalizowane procedury
obrad i głosowania \\
\midrule
\textbf{Styl\newline grupowy} & Znaczny stres wynikający z wymagań jakościowych
i ilościowych oraz ograniczeń czasowych & Relaksacyjne, niestresujące otoczenie;
brak sankcji & Otwartość i szczerość; Akceptacja procedur; unikanie wrogości \\
\midrule
\textbf{Normy\newline grupowe} & Profesjonalizm & Otwartość komunikacji;
konsensus; wspieranie oryginalności; eliminacja autorytaryzmu & Pragnienie osiągnięcia
porozumienia; konstruktywne postrzeganie konfliktu; akceptacja kompromisu \\
\bottomrule
\end{tabular}
